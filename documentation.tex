...
\begin{document}
    ...
    \subsection{V3 Messreihe 1: 100 Byte}\label{subsec:messreihe-v3-1-100-byte}
    \subsection{V3 Messreihe 2: 1400 Byte}\label{subsec:messreihe-v3-2:-1400-byte}
    \subsection{V3 Messreihe 3: 60000 Byte}\label{subsec:messreihe-v3-3:-60000-byte}
